...
sql = '''
    create or replace temporary view orders__dbt_tmp as
-- CTE to rank CDC records by Id, meta_ExtractedDate, and SYS_CHANGE_VERSION
WITH source_data AS (
    select * FROM lh_bronze.orders t1
)
...
# MAGIC   merge into lh_silver.orders as DBT_INTERNAL_DEST
# MAGIC       using orders__dbt_tmp as DBT_INTERNAL_SOURCE
# MAGIC       on 
# MAGIC               DBT_INTERNAL_SOURCE.SalesOrderID = DBT_INTERNAL_DEST.SalesOrderID
