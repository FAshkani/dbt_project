...
sql = '''
    create or replace temporary view order_territory__dbt_tmp as
...
# MAGIC %%sql
# MAGIC     create or replace temporary view order_territory__dbt_tmp as
...
# MAGIC   merge into lh_gold.order_territory as DBT_INTERNAL_DEST
# MAGIC       using order_territory__dbt_tmp as DBT_INTERNAL_SOURCE
# MAGIC       on 
