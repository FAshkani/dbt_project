...
notebook_files1 = ['model.dbt_project.dim_cities', 'model.dbt_project.dim_departments', 'model.dbt_project.dim_products', 'model.dbt_project.dim_territories', 'model.dbt_project.order_territory', 'model.dbt_project.order_territory1'] # type: ignore
