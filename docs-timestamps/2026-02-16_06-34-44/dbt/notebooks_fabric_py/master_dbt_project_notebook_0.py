...
notebook_files1 = ['model.dbt_project.cities', 'model.dbt_project.countries', 'model.dbt_project.departments', 'model.dbt_project.orders', 'model.dbt_project.products', 'model.dbt_project.territories'] # type: ignore
